...
def move(snake, food):
    ...
    if (x == food.coord[0] and y == food.coord[1]):
        ...
        label_score.config(text='Рахунок: {}'.format(score))
        canvas.delete('food')
...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,
                       font=('Futura PT', 50), text='Ви програли', fill='red')
...
label_score = Label(window, text='Рахунок: {}'.format(score), font=('Arial', 40))
label_score.pack()
